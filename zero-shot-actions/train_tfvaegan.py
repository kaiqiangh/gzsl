...
for epoch in range(0,opt.nepoch):
    ...
    if opt.gzsl_od:
        ...
        clsg = classifier_entropy.CLASSIFIER(data.train_feature, util_init.map_label(data.train_label,data.seenclasses), data, seen_class, \
    ...
    zsl_cls = classifier.CLASSIFIER(syn_feature, util_init.map_label(syn_label, data.unseenclasses), data, data.unseenclasses.size(0), \
